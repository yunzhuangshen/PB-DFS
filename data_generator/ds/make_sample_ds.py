...
if __name__ == '__main__':
    ...
    home = expanduser("~")
    # data_dir = f'{home}/storage1/instances/ds/train_500-1000'
    # remove_broken_sample(data_dir)
    # collect_samples(data_dir)
    # data_dir = f'{home}/storage1/instances/ds/test_1000'
    # remove_broken_sample(data_dir)
    # collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/ds/time_1000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/ds/time_3000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/ds/time_5000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/ds/time_7000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/ds/time_9000'
    collect_samples(data_dir)

...
if __name__ == '__main__':
    ...
    home = expanduser("~")
    data_dir = f'{home}/storage1/instances/vc/time_1000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/vc/time_3000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/vc/time_5000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/vc/time_7000'
    collect_samples(data_dir)
    data_dir = f'{home}/storage1/instances/vc/time_9000'
    collect_samples(data_dir)